...
if (length(args) != 4) {
  stop(
    "Usage : Rscript plot_trophic_abundance.R INPUT_OTU_DIRECTORY INPUT_FUNTRAITS_DIRECTORY OUTPUT_PLOT_DIRECTORY OUTPUT_PHYLOSEQ_DIRECTORY"
  )
}
